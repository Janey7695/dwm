...
static const char dmenufont[]       = "Symbols Nerd Font:size=12";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_lavender, "-sf", col_gray1, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *lightdown[]  = { "xbacklight", "-dec","5",NULL };
static const char *lightup[]  = { "xbacklight", "-inc","5" ,NULL};
static const char *volumdown[]  = { "amixer", "-qM","set", "Master","5%-", "umute",NULL };
static const char *volumup[]  = { "amixer", "-qM", "set", "Master", "5%+", "umute" ,NULL};
static const char *mutetoggle[]  = { "amixer","-qM", "set", "Master", "toggle" ,NULL};
